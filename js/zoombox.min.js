...
closeZoombox(){this.zoomboxBox.style.opacity='0';document.body.style.overflow='auto';this.checkPlay(!0);setTimeout(()=>{this.zoomboxBox.style.display='none';this.zoomboxBox.style.opacity='1';let last=this.zoomboxPreview.lastElementChild;while(last){this.zoomboxPreview.removeChild(last);last=this.zoomboxPreview.lastElementChild}},200);window.onkeydown=(e)=>{}
window.onwheel=(e)=>{}}
